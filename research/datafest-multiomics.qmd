...
The analysis used a nested validation framework to compare feature sets and model families while keeping final testing separate from model development. The workflow below is a web-native reconstruction of the analytical map I created for the team presentation; the confidential slide deck itself is not published.
